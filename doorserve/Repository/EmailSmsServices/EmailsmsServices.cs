...
namespace doorserve.Repository
{
    ...
    {
        public readonly doorserve.Repository.EmailSmsTemplate.ITemplate _template;
        public readonly doorserve.Repository.EmailHeaderFooters.IEmailHeaderFooters _headerFooters;
        public readonly doorserve.Repository.SMSGateway.IGateway _gateway;
        private readonly ApplicationDbContext _context;
        public EmailsmsServices()
        {
         
            _headerFooters = new doorserve.Repository.EmailHeaderFooters.EmailHeaderFooters();

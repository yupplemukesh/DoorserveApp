...
namespace TogoFogo.Controllers
{
    ...
    {
        private readonly IGateway _smtpGatewayModel;
        public SMTPGatewayController()

        {
            _smtpGatewayModel = new Gateway();
        }
        ...
        //    var getwayTypeId = getwaylist.Where(x => x.Text == "SMTP Gateway").Select(x => x.Value).SingleOrDefault();

        //    var smsgateway = await _smtpGatewayModel.GetGatewayByType(getwayTypeId);

        //    SMGateWayMainModel model = new SMSGateWayMainModel();

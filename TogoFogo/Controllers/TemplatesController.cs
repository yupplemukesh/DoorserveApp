...
namespace TogoFogo.Controllers
{
    public class TemplatesController : Controller
    {
        ...
        public async Task<ActionResult> Create()
        {
            ...
            templatemodel.MessageTypeList = new SelectList(await CommonModel.GetLookup("Message"), "Value", "Text");
            ...
            templatemodel.EmailHeaderFooterList = new SelectList(await CommonModel.GetLookup("EmailHeaderFooter"), "Value", "Text");
